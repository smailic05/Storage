...
//
// TODO: Extend the Storage service by defining new RPCs and
...
//
// TODO: Create an implementation of the Storage server
...
// implementation of Storage server interface service, but only
...
func NewBasicServer(database *gorm.DB) (pb.StorageServer, error) {
